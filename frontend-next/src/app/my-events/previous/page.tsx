...
const OrganizerPreviousEventsPage = () => {
                            ...
                            {filteredEvents.length > 0 ? (
                                filteredEvents.map((event, index) => (
                                    <motion.div key={event._id} className="event-card-wrapper" variants={itemVariants}>
                                        <div className="event-card-with-actions" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
...
export default OrganizerPreviousEventsPage;
